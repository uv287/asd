...
static void change_parent(pid_t child_pid, pid_t new_parent_pid)
{
...
static long my_ioctl(struct file *filp, unsigned int cmd, unsigned long arg)
{
    ...
    case IOCTL_CHANGE_PARENT:
        ...
        change_parent(ioctl_arg.child_pid, ioctl_arg.new_parent_pid);
        break;
    default:
        return -EINVAL;
    }
...
static int __init ioctl_driver_init(void)
{
    ...
    if ((ret = alloc_chrdev_region(&ioctl_dev, FIRST_MINOR, MINOR_CNT, "ioctl_dr_doom")) < 0)
    {
        return ret;
    }
    ...
    if (IS_ERR(device_create(ioctl_class, NULL, ioctl_dev, NULL, "ioctl_dr_doom")))
    {
...
MODULE_DESCRIPTION("ioctl_dr_doom driver change the parent of a process");

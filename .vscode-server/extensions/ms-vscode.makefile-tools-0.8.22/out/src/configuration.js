...
function getPreConfigureArgs() { return preConfigureArgs; }
exports.getPreConfigureArgs = getPreConfigureArgs;
function setPreConfigureArgs(args) { preConfigureArgs = args; }
exports.setPreConfigureArgs = setPreConfigureArgs;
let postConfigureScript;
function getPostConfigureScript() { return postConfigureScript; }
exports.getPostConfigureScript = getPostConfigureScript;
function setPostConfigureScript(path) { postConfigureScript = path; }
exports.setPostConfigureScript = setPostConfigureScript;
let postConfigureArgs = [];
function getPostConfigureArgs() { return postConfigureArgs; }
exports.getPostConfigureArgs = getPostConfigureArgs;
function setPostConfigureArgs(args) { postConfigureArgs = args; }
...
async function readPreConfigureArgs() {
    var _a;
    preConfigureArgs = (_a = await util.getExpandedSetting("preConfigureArgs")) !== null && _a !== void 0 ? _a : [];
...
async function readPostConfigureArgs() {
    var _a;
    postConfigureArgs = (_a = await util.getExpandedSetting("postConfigureArgs")) !== null && _a !== void 0 ? _a : [];
...
function getAlwaysPostConfigure() { return alwaysPostConfigure; }
exports.getAlwaysPostConfigure = getAlwaysPostConfigure;
function setAlwaysPostConfigure(path) { alwaysPostConfigure = path; }
...
function getConfigurationPreConfigureArgs() { return configurationPreConfigureArgs; }
exports.getConfigurationPreConfigureArgs = getConfigurationPreConfigureArgs;
function setConfigurationPreConfigureArgs(args) { configurationPreConfigureArgs = args; }
exports.setConfigurationPreConfigureArgs = setConfigurationPreConfigureArgs;
let configurationPostConfigureArgs = [];
function getConfigurationPostConfigureArgs() { return configurationPostConfigureArgs; }
exports.getConfigurationPostConfigureArgs = getConfigurationPostConfigureArgs;
function setConfigurationPostConfigureArgs(args) { configurationPostConfigureArgs = args; }
